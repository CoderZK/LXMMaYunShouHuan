...
@property (nonatomic, assign) BOOL isHaveDistanceDate;//是否有距离数据

@property (nonatomic, assign) BOOL isHaveJiBuDate;//是否有计步数据

@property (nonatomic, assign) BOOL isCurrent;//是否是当前点选的
